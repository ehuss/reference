...
An *associated item constraint* constrains an [associated type] of a trait.

r[generics.arguments.associated.equality]
...
r[generics.arguments.associated.bound]
...
> }
>
> let small: Grid<4, 4> = Grid::new();
> let large: Grid<1920, 1080> = Grid::new();
> assert_eq!(small.size(), 16);
> assert_eq!(large.size(), 2_073_600);
> ```
