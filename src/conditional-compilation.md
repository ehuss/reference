...
r[cfg.syntax]
{{ grammar ConfigurationPredicate ConfigurationOption ConfigurationAll ConfigurationAny ConfigurationNot ConfigurationPredicateList }}
...
{{ grammar CfgAttrAttribute CfgAttrs }}
