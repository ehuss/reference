...
(function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const onThisPageTitle = document.createElement('div');
        onThisPageTitle.classList.add('on-this-page-title');
        onThisPageTitle.textContent = 'On this page';
        onThisPage.appendChild(onThisPageTitle);
